...
### srand((unsigned) time(0)) (Intializes random number generator)
...
```
   0x0804874d <+6>:	mov    eax,DWORD PTR [ebp+0x8] ==> password buffer
   0x08048750 <+9>:	mov    edx,DWORD PTR [ebp+0xc] ===> 0x1337d00d
```
